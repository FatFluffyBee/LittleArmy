...
public class Swordman_Shield : Agent, I_Shield
{
    ...
    void Awake() 
    {
        ...
        var idle_RaiseShield = new Idle_RaiseShield(this, this);
    ...
    void Update(){ 
        ...
        TargetShield = GetClosestTargetInRange(shieldViewRange, AgentType.Ennemi, TargetType.Range, DistMode.View);
